...
export default function Create() {
  ...
  const [showEnterAmount, setShowEnterAmount] = useState<boolean>(false);
  ...
  return (
    <div className={styles.container}>
      <div className={styles.topBlock}>
        <h1 className={styles.headline}>Create</h1>
      ...
      {showEnterAmount && <EnterAmount setShow={setShowEnterAmount} />}
